export enum Messages {
  ...
  CONFIG_CREATED = 'A configuration file has been created in the project root as "sib-config.json". You can modify it at any time or use "npx sib --init" to reconfigure.\nPress any key to continue...',
